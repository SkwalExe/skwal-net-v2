...
def unknown_subdomain(request):
    return error_page(request, "404", "The requested subdomain was not found. If you typed the adress manually, check your spelling. If you clicked a link, it may be broken, please contact us with the link below.")
